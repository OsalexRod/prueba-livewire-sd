...
<div x-data="{ showModal: false }">
    ...
    <button @click="showModal = true" type="button" class="mr-2 bg-red-300 rounded-md w-20 hover:bg-red-400 focus:outline-none focus:ring focus:ring-red-500">Eliminar</button>
    <!-- Background overlay -->
          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline"> Eliminar Cliete </h3>
                <div class="mt-2">
                  <p class="text-sm text-gray-500"> Esta seguro que desea eliminar <span class="font-bold">El cliente X</span>? Esta accion no puede ser desecha </p>
                </div>
              </div>
            </div>
          </div>
